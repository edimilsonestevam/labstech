...
public class SearchCarModels extends Base {
	...
	public void chooseBudget (String minimumValue, String maximumValue) {
		...
		String minimumPrice = "budgetInputMin";
		String maximumPrice = "budgetInputMax";
		
		element.findElement(By.xpath(choosedBudget)).click();
		element.findElement(By.id(minimumPrice)).clear();
		element.findElement(By.id(minimumPrice)).sendKeys(minimumValue);
		element.findElement(By.id(maximumPrice)).clear();
		element.findElement(By.id(maximumPrice)).sendKeys(maximumValue);
