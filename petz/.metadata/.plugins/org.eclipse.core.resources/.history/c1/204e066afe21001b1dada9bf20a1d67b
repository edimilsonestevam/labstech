...
public class TestSteps {
	...
	protected static String url = "http://5b847b30db24a100142dce1b.mockapi.io/api/v1/simulador";
	...
	public void o_sistema_apresenta_o_identificador_da_simulacao_mes_de_investimento_e_valor_de_investimento(int identificador, String mesInvestimento, String valorInvestimento) throws Throwable {
		...
		new SimularInvestimentoPoupancaService().validarMesInvestimento(url, identificador, mesInvestimento);
		new SimularInvestimentoPoupancaService().validarValorInvestimento(url, identificador, valorInvestimento);
