...
public class Cart extends Base {
	...
	public void checkItemsTotal(String expectedItemsTotal) {
		...
		String itemsTotal = "//h3[contains(text(),'" + expectedItemsTotal + " item')]";
	...
	public void checkTotalPrice(String expectedTotalPrice) throws InterruptedException {
	...
	public void goBackHome(String expectedUrl) throws InterruptedException {
